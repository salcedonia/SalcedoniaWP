...
function bootstrap_scripts()
{
	...
	wp_register_script( 'validate-script', 'http://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/jquery.validate.min.js', array( 'jquery' ) );
	wp_register_script( 'jsalcedo-script', get_template_directory_uri() . '/js/jsalcedo.js', array( 'jquery' ) );
        wp_register_script( 'fancyBox-script', get_template_directory_uri() . '/fancyBox/source/jquery.fancybox.pack.js?v=2.1.5', array( 'jquery' ) );
	...
	wp_enqueue_script( 'validate-script' );
        ...
        wp_enqueue_script( 'jsalcedo-script' );
}
...
function bootstrap_styles()
{
	...
	wp_register_style( 'magnific', get_template_directory_uri() . '/css/magnific.css', array(), '0.9.4', 'all' );
        wp_register_style( 'fancyBox-style', get_template_directory_uri() . '/fancyBox/source/jquery.fancybox.css', array(), '2.1.5', 'all' );
