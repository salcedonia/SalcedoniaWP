...
<div id="comments" class="comments-area">
    ...
    <?php comment_form(
        $fields =  array(
            ...
            'label_submit' => 'Send',
            'comment_field' => '<div class="comment-form-comment form-group"><textarea id="comment" class="form-control" name="comment" rows="10" cols="20" placeholder="Enter Your Message" aria-required="true"></textarea></div>'
        ) ); ?>
