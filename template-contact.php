...
<?php
   if(isset($_POST['submitted'])) {
    ...
    if(!isset($hasError)) {
        ...
        $subject = '[JavierSalcedo.net] From '.$name;
        $body = "Name: $name \n\nEmail: $email \n\nComments: $comments";
                ...
                <form action="<?php the_permalink(); ?>" id="contactForm" method="post">
                    <fieldset>
                        <div class="form-group">
                            <input class="form-control" type="text" name="contactName" id="contactName" value="" placeholder="Enter Your Name" />
                            <?php if(isset($nameError)) { ?>
			    <div class="alert alert-danger" role="alert">
  			      <i class="fa fa-exclamation-triangle"></i> <?=$nameError;?>
			    </div>
                            <?php } ?>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="alert alert-danger" role="alert">
  			      <i class="fa fa-exclamation-triangle"></i> <?=$emailError;?>
			    </div>
                            <?php } ?>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" name="comments" id="commentsText" rows="10" cols="20" placeholder="Enter Your Message"></textarea>
                        </div>
